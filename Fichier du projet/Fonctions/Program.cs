...
namespace Fonctions
{
    ...
    internal class Program
    {
            ...
            while (!succes)
            {
                ...
                if (succes)
                {
                    if (pRestriction == "min")
                    {
                        ...
                        {
                            succes = false;
                            if (Choix == char.Parse(gMajuscules[i].ToLower())) { succes = true; break; }
                        }
                    }
                    if (pRestriction == "maj") 
                    {
                        ...
                        for (int i = 0; i < gMajuscules.Length; i++)
                        {
                            if (Choix == char.Parse(gMajuscules[i])) { succes = true; }
                        }
                    }
                    if (pRestriction == "ltr")
                    {
                        ...
                        for (int i = 0; i < gMajuscules.Length; i++)
                        {
                            if (Choix == char.Parse(gMajuscules[i]) || Choix == char.Parse(gMajuscules[i].ToLower())) { succes = true; }
                        }
                    }
                }
        ...
        static void Ex3()
        {
            CharTryParse("Entrez un char (restriction maj) :", "maj");
            CharTryParse("Entrez un char (restriction min) :", "min");
            CharTryParse("Entrez un char (restriction ltr) :", "ltr");
        }
        ...
        /// <summary>
        /// Une boucle infini pour finir le script. Juste pour qu'à la fin on ne voit pas tout le texte laid avec le chemin absolu et tout
        /// </summary>
        static void Fin()
        {
            while (true)
